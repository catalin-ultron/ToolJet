...
import Azureblobstorage from './packages/azureblobstorage/lib/manifest.json'
...
import Databricks from './packages/databricks/lib/manifest.json'
...
import Grpcv2 from './packages/grpcv2/lib/manifest.json'
...
import Nocodb from './packages/nocodb/lib/manifest.json'
...
import AzureblobstorageOperation from './packages/azureblobstorage/lib/operations.json'
...
import DatabricksOperation from './packages/databricks/lib/operations.json'
...
import Grpcv2Operation from './packages/grpcv2/lib/operations.json'
...
import NocodbOperation from './packages/nocodb/lib/operations.json'
...
import azureblobstorageSvg from './packages/azureblobstorage/lib/icon.svg'
...
import databricksSvg from './packages/databricks/lib/icon.svg'
...
import grpcv2Svg from './packages/grpcv2/lib/icon.svg'
...
import nocodbSvg from './packages/nocodb/lib/icon.svg'
...
Azureblobstorage: AzureblobstorageOperation,
...
Databricks: DatabricksOperation,
...
athena: athenaSvg,
azureblobstorage: azureblobstorageSvg,
baserow: baserowSvg,
