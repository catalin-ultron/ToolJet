...
const labelVariants = cva('tw-font-medium peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70', {
  ...
  compoundVariants: [
    { type: 'label', size: 'default', className: 'tw-text-[12px]/[18px]' },
    { type: 'label', size: 'large', className: 'tw-text-[14px]/[20px]' },
    { type: 'helper', size: 'default', className: 'tw-text-[11px]/[16px]' },
    { type: 'helper', size: 'large', className: 'tw-text-[12px]/[18px]' },
  ],
});
